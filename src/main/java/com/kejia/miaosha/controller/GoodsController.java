...
import com.kejia.miaosha.vo.GoodsDetailVo;
...
//    	 return "goods_list";
		...
		System.out.println("kkkkkkkkkkkkkkkkkkkkkkkkllllllllllllllllllllllllllll");
		return html;
	}

	@RequestMapping(value="/to_detai2/{goodsId}",produces="text/html")
	@ResponseBody
